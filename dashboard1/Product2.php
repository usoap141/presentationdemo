    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li><a href="Product1.php">RM 10.00</a></li>
            <li class="active"><a href="Product2.php">RM 20.00</a></li>
        ...
        <div class="col-sm-9 col-md-10 main">
		  ...
		  <?php
	$product_array = $db_handle->runQuery("SELECT * FROM `tblproduct` WHERE Price=20.0");
