      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">View Image</h4>
						...
						$html .= "<div class=\"modal-body\"><img src='{$url}'></div>";
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						...
						$html .= "<script>$('#myModal').modal('show');</script>";
					}
                } else {
                    $html = "<div class=\"alert alert-danger\" role=\"alert\">";
                    $html .= "Failed to view image</div>";
                }
                echo $html;
            }
            ?>
            ...
            <?php
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                    ...
                    $html .= "<input type='hidden' name='view' value='{$row['id']}'>";
                    $html .= "<button type=\"submit\" class=\"btn btn-primary\">View</button>";
                    $html .= "</form></td>";
                    $html .= "</tr>";
                    echo $html;
                }
